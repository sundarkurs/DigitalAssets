...
INSERT INTO Folder(Id,  Name, ParentId, AssetType, UpdatedOn, UpdatedBy) 
	VALUES('DE6B1F74-455C-4B49-9941-B76D66B4CCB2', 'Product Image', NULL, 1, GETDATE(), 'Sundar Urs')

GO
INSERT INTO Folder(Id,  Name, ParentId, AssetType, UpdatedOn, UpdatedBy) 
	VALUES('11DDA5FB-5B63-44FC-8165-2969882DC7E7', 'Image', NULL, 2, GETDATE(), 'Sundar Urs')